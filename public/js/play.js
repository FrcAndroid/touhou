$(document).ready(function(){
    ...
    getdetails('/play/getData', values)
                    ...
                    getdetails('/play/getMap', values)
                        .done(function(response){
                            if(response.success !== undefined){
                                ...
                                $("#mainSprite").append("<img src="+ mapsUrl +"/"+ id + "/" + main+">");
                                img.src = mapsUrl +"/"+ id + "/" + event;

                                //load sprite
                                $("#userSprite").append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/"+ response.position.direction +"-idle.png>")
                                moveDirection = 'up';
                                if(response.position !== undefined){
                                    $("#userSprite").children().css({top: response.position.charY+"px", left: response.position.charX+"px"});
                                }
    ...
    function mapZero(userData){
        ...
        getdetails('/play/getConversation', values)
            .done(function(response){
               if(response.success !== undefined){
                   ...
                   getdetails('/play/processConversation', values)
                       .done(function(response){
                           if(response.success !== undefined){
                               $("#textBox").html(conversationArray[convArrayIndex].lineContent);

                               $("#npcSpritePosition").empty();

                               if(conversationArray[convArrayIndex].animation !== null){
                                   $("#npcSpritePosition").append("<img src='animations/"+ conversationArray[convArrayIndex].character + "/"+ conversationArray[convArrayIndex].animation + ".png'>");
                               }
                               else{
                                   $("#npcSpritePosition").append("<img src='animations/"+ conversationArray[convArrayIndex].character + "/1.png'>");
                               }
    ...
    $(document).on('keydown', function(event){
        switch(controlEnvironment){
            ...
            case 'field':
                let movement = 10;
                let top = parseInt($("#userSprite").children().first().css('top'), 10);
                let left = parseInt($("#userSprite").children().first().css('left'), 10);
                var x, y;
                switch(event.keyCode){
                    case 38:
                        //up arrow
                        ...
                        if(!canMove){
                            ...
                            if(moveDirection === 'up'){
                                if(moveIdle === true){
                                    ...
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/up-move.png>")
                                    moveIdle = false;
                                }
                                else{
                                    //change animation to idling
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/up-idle.png>")
                                    moveIdle = true;
                                }
                            }
                            else{
                            ...
                            $("#userSprite").children().css({top: y +"px", left: x});
                        }
                    ...
                    case 37:
                        ...
                        if(!canMove){
                            ...
                            if(moveDirection === 'left'){
                                if(moveIdle === true){
                                    //change animation to moving
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/left-move.png>")
                                    moveIdle = false;

                                }
                                else{
                                    //change animation to idling
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/left-idle.png>")
                                    moveIdle = true;
                            ...
                            $("#userSprite").children().css({top: y, left: x +"px"});
                    ...
                    case 39:
                        ...
                        if(!canMove){
                            ...
                            if(moveDirection === 'right'){
                                if(moveIdle === true){
                                    //change animation to moving
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/right-move.png>")
                                    moveIdle = false;
                                }
                                else{
                                    //change animation to idling
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/right-idle.png>")
                                    moveIdle = true;
                                }
                            }
                            else{
                    ...
                    case 40:
                        ...
                        if(!canMove){
                            ...
                            if(moveDirection === 'down'){
                                if(moveIdle === true){
                                    //change animation to moving
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/down-move.png>")
                                    moveIdle = false;
                                }
                                else{
                                    //change animation to idling
                                    $("#userSprite").html('').append("<img src="+ playerSpritesUrl +"/"+ userData.sprite +"/down-idle.png>")
                                    moveIdle = true;
                                }
                            }
                            else{
    ...
    function checkEvent(x,y){
        ...
        if(p[0] === 0 && p[1] === 0 && p[2] === 0 && p[3] === 0){//check if its nothing
            inEventRange = false;
            canMove = true;
        }
        else if(p[0] === 0 && p[1] === 255 && p[2] === 248 && p[3] === 255){//check if its hitbox
            ...
            if (chance > 90) {
                ...
                getdetails('/play/getMapData', values)
                    .done(function (response) {
                        if (response.success !== undefined) {
                            //we have map data
                            var mapLevel = response.success.levelRange.split('-');
                            var charLevel = mapLevel[Math.floor(Math.random() * mapLevel.length)];

                            var mapChars = response.success.mapChars.split(',');
                            var charId = mapChars[Math.floor(Math.random() * mapChars.length)];
                            values = {
                                charLevel: charLevel,
                                charId: charId,
                                user: user
                            }
                            getdetails('/play/createWildCharacter', values)
                                .done(function(response){
                                    if(response.success !== undefined){
                                        //true
            ...
            getdetails('/play/getEventCode', values)
                .done(function(response){
                    if(response.success !== undefined){
                        if(response.success.eventType === "change"){
                            ...
                            if(response.userevent !== undefined){
                                if(response.userevent.callable === "true"){
                                    ...
                                    conversationId = response.success.conversationTrigger;
                                }
                                else{
                                    canMove = true;
                                }
    ...
    function processEvent(eventId){
        ...
        switch(eventId){
            case 1:
                ...
                $("#playField").append("<img id='event1Img' src='"+ img +"'>");
                break;
            case 2:
                //remove picture
                $("#event1Img").remove();
            ...
            case 3:
                ...
                let button1= "<input type='image' src='"+ src1 +"' class='btTxt genderButton tutorialSprite' id='maleSprite'>";
                let button2= "<input type='image' src='"+ src2 +"' class='btTxt genderButton tutorialSprite' id='femaleSprite'>";
                ...
                getdetails('/play/getMap', values)
                    .done(function(response){
                        if(response.success !== undefined){
                            ...
                            //append map to playfield
                            $("#mainSprite").append("<img src="+ mapsUrl +"/"+ id + "/" + main+">")
                            $("#eventSprite").append("<img src="+ mapsUrl +"/"+ id + "/" + event+">")
            ...
            case 33:
                ...
                $("#shopModal").children().children().children().first().attr('data-id', '#store_town1');
                break;
            case 34:
                ...
                getdetails('/play/getCharacter', values)
                    .done(function(response){
                        if(response.success !== undefined){
                ...
                if(response.success !== undefined){
                    ...
                    $.each(charData, function(i){
                        ...
                        $.each(moveList[i], function(j){
                                moveDiv += "<tr><td>"+ moveList[i][j].type + "</td><td>" +moveList[i][j].name + "</td><td>"+ moveList[i][j].description + "</td><td>"+ moveList[i][j].power + "</td><td>" + moveList[i][j].accuracy +"</td><td>" + moveList[i][j].cost + "</td>";
                        });

                        $("#characterList").append("<div class='buttonPos' id='"+ charData[i].position + "'><button value='"+ charData[i].position + "' class='float-right btn btn-default btn-success'>Sort</button></div>");
                        $("#characterList").append("<div class=cont><div class='leftrow'>" +
                            "<img class='spriteImg' src='"+ img +"'>"+

                            "<div class='toprow'><div class='charName'>"+ charData[i].char_name +
                            "<div class='charLevel'>Lv."+ lvl +
                            "<div class='exp'>Exp:"+ exp +"/1000</div>"+
                            "</div></div></div>"+

                            "<div class='middlerow'><div class='health'>HP:"+ charData[i].healthPointsCurrent+"/"+ charData[i].healthpoints +"</div>"+
                            "<div class='stamina'>ST:"+ charData[i].staminaPointsCurrent+"/"+ charData[i].staminapoints +"</div>" +
                            "</div>"+

                            "<div class='thirdrow'><div>"+ charData[i].type +"</div></div>"+
                            "<div class='fourthrow'><div>"+ charData[i].skill_name +": "+ charData[i].skill_desc +"</div></div>"+

                            "<div class='rightrow'><table class='table-bordered'>" +
                            "<tr><td class='firstTD'>ATK:</td><td>"+atk+"</td></tr>" +
                            "<tr><td class='firstTD'>DEF:</td><td>"+def+"</td></tr>" +
                            "<tr><td class='firstTD'>SPE:</td><td>"+spe+"</td></tr>" +
                            "</table></div></div>"+
                            "<div class='moverow'><table class='table-bordered'><th>Type</th><th>Name</th><th>Description</th><th>Power</th><th>Accuracy</th><th>Cost</th>"+moveDiv +"</table></div></div>");
               ...
               .done(function(response){
                       if(response.success !== undefined){
                           ...
                           $.each(itemList, function(i){
                               let img = "/sprites/items/" + itemList[i].name + "/sprite.png";
                               let useButton = itemList[i].category !== "battle_item"?
                                   "<button id='"+ itemList[i].id+ "'class='btn-success btn btn-default itemUse'>Use</button>":
                                   "";

                               itemDiv += "<tbody><tr class='itemFrame'><td><img class='itemImg' src='"+ img +"'></td>"+
                                   "<td>"+ itemList[i].name +"</td>"+
                                   "<td>"+ itemList[i].desc +"</td>"+
                                   "<td>"+ itemList[i].stock +"</td>"+
                                   "<td>"+useButton+"</td></tr>"

                           });

                           $("#itemsDiv").append("<table class='table-bordered'>" +
                               "<th></th>" +
                               "<th>Name</th>"+
                               "<th>Desc</th>" +
                               "<th>Stock</th>"+
                               "<tbody>"+ itemDiv +"</tbody></table>");
    ...
    $(".dataButton").on('click', function(){
        ...
        getdetails('play/getDataCard', values)
            .done(function(response){
                if(response.success !== undefined){
                    $("#cardDiv").empty();
                    ...
                    let cardDiv = "<div id='cardCont'>" +
                        "<div id='cardSpriteDiv'><img id='cardSprite' src='"+ img +"'></div>" +
                        "<div id='cardName'>"+ data.nick +"</div>"+
                        "<div id='cardBalance'>Balance: "+ data.balance +"</div>"+
                        "<div id='cardBadges'>Badges: "+ data.progress +"</div>"+
                        "</div>"
    ...
    $(document).on('click', '.buttonPos', function(){
        ...
        if(positionArray.length === 2){
            ...
            for(let i=0; i<positionArray.length; i++){
                if(i === 0){
                    ...
                    if(positionArray[i] === num){
                        ...
                        $(".buttonPos").children().removeClass('btn-danger').addClass('btn-success').html('Sort');
                        positionArray = [];
                        canSort = false;
                    }
                }
            ...
            if(canSort === true){
                ...
                getdetails('/play/sortCharacters', values)
                    .done(function(response){
                        if(response.success !== undefined) {
                            charData = response.success;
                            if(response.moveList !== undefined){
    ...
    $(".buyButton").on('click', function(){
        $("#buyModal").modal('show');
        var shopId = $("#shopModal").children().children().children().first().attr('data-id');
            ...
            .done(function(response){
                if(response.success !== undefined){
                    ...
                    $.each(itemList, function(i){
                        ...
                        shopDiv += "<tbody><tr class='itemFrame'><td><img class='itemImg' src='"+ img +"'></td>"+
                            "<td>"+ itemList[i].name +"</td>"+
                            "<td>"+ itemList[i].description +"</td>"+
                            "<td>"+ itemList[i].buyPrice +"</td>"+
                            "<td><input type='number' class='itemBuyNum'><button id='"+ itemList[i].id+ "'class='btn-success btn btn-default buyItemButton'>Buy</button></td></tr>"



                    })

                    $("#shopBuyList").append("Balance: "+ response.balance.balance+"<table class='table-bordered'>" +
                        "<th></th>" +
                        "<th>Name</th>"+
                        "<th>Description</th>" +
                        "<th>Buy price</th>" +
                        "<tbody>"+ shopDiv +"</tbody></table>");
                ...
                if(response.success !== undefined){
                    ...
                    $.each(itemList, function(i){
                        ...
                        shopDiv += "<tbody><tr class='itemFrame'><td><img class='itemImg' src='"+ img +"'></td>"+
                            ...
                            "<td>"+ itemList[i].description +"</td>"+
                            "<td>"+ itemList[i].stock +"</td>"+
                            "<td>"+ itemList[i].sellPrice +"</td>"+
                            "<td><input type='number' max='"+ itemList[i].stock +"' class='itemBuyNum'><button id='"+ itemList[i].name+ "'class='btn-success btn btn-default sellItemButton'>Sell</button></td></tr>"



                    });

                    $("#shopSellList").append("Balance: "+ response.balance.balance+"<table class='table-bordered'>" +
                        "<th></th>" +
                        "<th>Name</th>"+
                        "<th>Desc</th>" +
                        "<th>Stock</th>"+
    ...
    $(document).on('click', '.buyItemButton', function(){
        ...
        if(numberOfItems !== ""){
            ...
            getdetails("/play/buyItem", values)
                .done(function(response){
                    if(response.success !== undefined){
    ...
    $(document).on('click', '.sellItemButton', function(){
        ...
        if(numberOfItems !== ""){
            ...
            getdetails("/play/sellItem", values)
                .done(function(response){
                    if(response.success !== undefined){
                                ...
                                if(response.success !== undefined){
                                    ...
                                    $.each(itemList, function(i){
                                        ...
                                        shopDiv += "<tbody><tr class='itemFrame'><td><img class='itemImg' src='"+ img +"'></td>"+
                                            ...
                                            "<td>"+ itemList[i].stock +"</td>"+
                                            "<td>"+ itemList[i].sellPrice +"</td>"+
                                            "<td><input type='number' class='itemBuyNum'><button id='"+ itemList[i].name+ "'class='btn-success btn btn-default sellItemButton'>Sell</button></td></tr>"
            ...
            .done(function(response){
                if(response.success !== undefined){
                    ...
                    $.each(charData, function(i){
                        ...
                        $("#itemUseList").append("<div class='itemPos' id='"+ charData[i].position + "'><button value='"+ charData[i].position + "' id='"+ id +"' class='float-right btn btn-default btn-success useItemButton'>Use</button></div>");
                        $("#itemUseList").append("<div class=cont><div class='leftrow'>" +
                            "<img class='spriteImg' src='"+ img +"'>"+
    ...
    $(document).on('click', '.useItemButton', function(){
        ...
        var id = this.id
        getdetails('/play/useItem', values)
            .done(function(response){
                if(response.success !== undefined){
    ...
    $(document).on('click', '.genderButton', function(){
        ...
        getdetails('/play/chooseSprite', values)
            .done(function(response){
                if(response.success !== undefined){
                    $(".genderButton").remove()
                }
    ...
    function getBattleData(trainerId, rivalId) {
        ...
        getdetails('/play/getBattleData', values)
            .done(function(response){
                if(response.success !== undefined){
    ...
    function startBattle(){
        ...
        switch (rivalData[0].data.owner){
            case "#rival_1":
                $("#battleText").html("Marisa has challenged you to a battle!").fadeToggle(2000, function(){
                    $("#battleText").empty().html(turnBasedSkills(trainerData[0].data.skill_id, trainerData[0])).fadeToggle(2000, function(){
                        $("#battleText").empty().html(turnBasedSkills(rivalData[0].data.skill_id, rivalData[0])).fadeToggle(2000, function(){
            ...
            case "#route1_trainer1":
                $("#battleText").html("Ace Trainer Mauricio challenges you!").fadeToggle(2000, function(){
                    $("#battleText").empty().html(turnBasedSkills(trainerData[0].data.skill_id, trainerData[0])).fadeToggle(2000, function(){
                        $("#battleText").empty().html(turnBasedSkills(rivalData[0].data.skill_id, rivalData[0])).fadeToggle(2000, function(){
                            $("#buttonBar").removeAttr('hidden');
                            //ready for turn 1
                ...
                break;
            case "#gymleader_1":
                $("#battleText").html("Gym Leader Aya challenges you!").fadeToggle(2000, function(){
                    $("#battleText").empty().html(turnBasedSkills(trainerData[0].data.skill_id, trainerData[0])).fadeToggle(2000, function(){
                        $("#battleText").empty().html(turnBasedSkills(rivalData[0].data.skill_id, rivalData[0])).fadeToggle(2000, function(){
                            $("#buttonBar").removeAttr('hidden');
                            //ready for turn 1
                ...
                break;
            default:
                $("#battleText").html("Wild "+ rivalData[0].data.char_name+ " appears!").fadeToggle(2000, function(){
                    $("#battleText").empty().html(turnBasedSkills(trainerData[0].data.skill_id, trainerData[0])).fadeToggle(2000, function(){
                        $("#battleText").empty().html(turnBasedSkills(rivalData[0].data.skill_id, rivalData[0])).fadeToggle(2000, function(){
                            $("#buttonBar").removeAttr('hidden');
                            //ready for turn 1
        ...
        $("#atkBtn").on('click', function(){
            ...
            for(let i = 0; i <= 4; i++){
                if(trainerData[0].moves[i] !== undefined){
                    //assign to button
                    $("#atkBtn"+ j).append("<button class='atkCommand btn btn-default btn-lg' data-position='"+ i +"' id='"+ trainerData[0].moves[i].id +"'>"+ trainerData[0].moves[i].name + "<br>"+ trainerData[0].moves[i].type +"<br> Cost:"+ trainerData[0].moves[i].cost+"    </button>");
                }
            }
            ...
            getdetails('/play/getItems', values)
                .done(function(response){
                    if(response.success !== undefined){
                        ...
                        $.each(itemList, function(i){
                            let img = "/sprites/items/" + itemList[i].name + "/sprite.png";
                            if(combatType !== "trainer" && itemList[i].id === 1){//allow usage of capture device only if its not a trainer battle
                                 useButton = "<button id='"+ itemList[i].id+ "' class='btn-success btn btn-default itemBattleUse'>Use</button>";
                            }
                            else{
                                if(itemList[i].id !== 1){
                                    useButton = "<button id='"+ itemList[i].id+ "' class='btn-success btn btn-default itemBattleUse'>Use</button>";
        ...
        $("#charBtn").on('click', function(){
            ...
            $.each(trainerData, function(i){
                ...
                //get sprite id
                let img = "/sprites/characters/" + trainerData[i].data.char_name + "/sprite.png";
                let lvl = trainerData[i].data.level;


                var moveDiv = "";
                $.each(trainerData[i].moves, function(j){
                    moveDiv += "<tr><td>"+ trainerData[i].moves[j].type + "</td><td>" +trainerData[i].moves[j].name + "</td><td>"+ trainerData[i].moves[j].description + "</td><td>"+ trainerData[i].moves[j].power + "</td><td>" + trainerData[i].moves[j].accuracy +"</td><td>" + trainerData[i].moves[j].cost + "</td>";
                });

                $("#charList").append("<div class='charCommand' id='"+ trainerData[i].data.position + "'><button value='"+ trainerData[i].data.position + "' class='float-right btn btn-default btn-success'>Change</button></div>");
                $("#charList").append("<div class=cont><div class='leftrow'>" +
                    "<img class='spriteImg' src='"+ img +"'>"+

                    "<div class='toprow'><div class='charName'>"+ trainerData[i].data.char_name +
                    "<div class='charLevel'>Lv."+ lvl +
                    "</div></div></div>"+

                    "<div class='middlerow'><div class='health'>HP:"+ trainerData[i].data.healthPoints+"/"+ trainerData[i].data.maxHealth +"</div>"+
                    "<div class='stamina'>ST:"+ trainerData[i].data.staminaPoints+"/"+ trainerData[i].data.maxStamina +"</div>" +
                    "</div>"+

                    "<div class='thirdrow'><div>"+ trainerData[i].data.type +"</div></div>"+
                    "<div class='fourthrow'><div>"+ trainerData[i].data.skill_name +": "+ trainerData[i].data.skill_desc +"</div></div>"+
    ...
    $("#escBtn").on('click', function(){
        if(combatType !== "trainer"){
            ...
            $("#buttonBar").attr('hidden', 'true').fadeToggle(100, function(){
                $("#battleText").html("You can't escape a trainer battle!").fadeToggle(2000, function(){
                    $("#battleText").html('');
                    $("#buttonBar").removeAttr('hidden');
                })
            })
    ...
    $(document).on('click','.itemBattleUse',  function(){
        ...
        if(this.id == 1){
            ...
            if(chance > 0){
                //captured
                $("#battleText").html('Captured successfully!').fadeToggle(2000, function(){
                    values = {
                        user: user,
                        rivalId: rivalData[0].data.owner
                    }
                    getdetails('/play/getCapturedChar', values)
                        .done(function(response){
                            if(response.success !== undefined){
                                captured = true;
                                finishBattle();
                ...
                //proceed with turn
                $("#battleText").html('Failed to capture!').fadeToggle(2000, function(){
            ...
            $.each(trainerData, function(i){
                ...
                $("#itemUseList").append("<div class='itemPos' id='"+ trainerData[i].data.position + "'><button value='"+ trainerData[i].data.position + "' id='"+ id +"' class='float-right btn btn-default btn-success itemCommand'>Use</button></div>");
                $("#itemUseList").append("<div class=cont><div class='leftrow'>" +
                    "<img class='spriteImg' src='"+ img +"'>"+
    ...
    $(document).on('click', '.itemCommand', function(){
        ...
        switch (itemId) {
            case 2:
                'heal 20 hp'
                //check hp
                if(trainerData[position].data.healthPoints !== trainerData[position].data.maxHealth){
                    var leftToMax = trainerData[position].data.maxHealth - trainerData[position].data.healthPoints;
                    var heal = 20;
                    if(leftToMax < heal){
                        heal -= leftToMax;
                    }
    ...
    function checkSupportAttack(moveId, attackerId) {
        ...
        switch(moveId){
            case 2:
                ...
                attackerId === "user" ? trainerData[0].data.def += 1 : rivalData[0].data.def;
                return "'s defense raised by 1.";
            case 4:
                //speed +1
                attackerId === "user" ? trainerData[0].data.speed += 1 : rivalData[0].data.speed;
                return "'s speed raised by 1.";
            case 8:
                //reduces enemy speed by 1
                attackerId === "user" ? rivalData[0].data.speed -= 1 : trainerData[0].data.speed -=1;
                return "'s defense raised by 1.";
            case 11:
            ...
            case 13:
                //restore 50% health
                attackerId === "user" ? trainerData[0].data.healthPoints += trainerData[0].data.healthPoints * 50 / 100  : rivalData[0].data.healthPoints += rivalData[0].data.healthPoints * 50 / 100;
    ...
    function finishBattle(trainerData, result) {
        ...
        if(result === "lose"){
            //uh oh u lost
            $("#battleText").html("You lost!").fadeToggle(2000, function () {
            ...
            getdetails("/play/updateData", values)
                .done(function(response){
                    if(response.success !== undefined){
                        $("#battleText").html("You win!").fadeToggle(2000, function () {
            ...
            if(captured === false){
                ...
                getdetails('/play/deleteTempChar', values)
                    .done(function(response){
                    if(response.success !== undefined){}
                    });
            }
    ...
    function attackProcess(attackerId, positionId) {
        if(attackerId === "user"){
            ...
            if(trainerData[0].moves[positionId].power>0){
                var attackFormula = trainerData[0].data.atk + trainerData[0].moves[positionId].power * (100/(100+ rivalData[0].data.def));
                //check STAB and type
                if(trainerData[0].data.type === trainerData[0].moves[positionId].type){
                    attackFormula *= 1.25;
                }
                //type weakness chart
                attackFormula *= typeWeakness(trainerData[0].moves[positionId].type, rivalData[0].data.type); // returns type multiplier
                ...
                if(hits > accuracy){
                    $("#battleText").html('Attack failed!').fadeToggle(2000, function(){$("#battleText").html('')});
                    return true;
                }
                else{
                    //hit
                    trainerData[0].data.staminaPoints -= trainerData[0].moves[positionId].cost;
                ...
                if(hits > accuracy){
                    ...
                    let html = checkSupportAttack(trainerData[0].moves[positionId].id, attackerId);
                ...
                var attack = rivalData[0].moves[Math.floor(Math.random() * rivalData[0].moves.length)];
            if(attack.power > 0){
                //attack is the random attack
                var attackFormula = rivalData[0].data.atk + attack.power * (100/(100+ trainerData[0].data.def));
                //check STAB and type
                if(rivalData[0].data.type === attack.type){
                    attackFormula *= 1.25;
                }
                //type weakness chart
                attackFormula *= typeWeakness(attack.type, trainerData[0].data.type); // returns type multiplier
                attackFormula = Math.floor(attackFormula/2);
                ...
                if(hits > accuracy){
                    ...
                    else if(trainerData[0].data.healthPoints - attackFormula < 0){
                        trainerData[0].data.healthPoints = 0;
                    }
                    else{
                        trainerData[0].data.healthPoints -= attackFormula;
                        $("#battleText").html(rivalData[0].data.char_name + ' uses ' + attack.name).fadeToggle(2000, function(){$("#battleText").html('')});
                    }
                    //check if youre dead
    ...
    function processBattleTurn(userAction, idAction){
        ...
        switch (userAction) {
            case "attack":
                //attack command, id is the attack that has been used
                    ...
                    if (trainerData[0].data.speed > rivalData[0].data.speed) {
                     $("#battleText").html(trainerData[0].data.char_name + ' uses ' + trainerData[0].moves[idAction[1]].name).fadeToggle(2000, function () {
                             ...
                             if (canAttack) {
                                 ...
                                 $("#battleText").fadeToggle(2000, function () {
                                     if (!canAttack) {
                                         ...
                                         //turn over
                                         turnBasedSkills(trainerData[0].data.skill_id, trainerData[0]);
                                         turnBasedSkills(trainerData[0].data.skill_id, rivalData[0]);
                                         $("#buttonBar").removeAttr('hidden');
                                     }
                                 })
                             }
            ...
            case "item":
                ...
                $("#battleText").html('Used ' + idAction).fadeToggle(2000, function () {
                    //enemy turn
                    let canAttack = attackProcess('rival', '');
                    $("#battleText").fadeToggle(2000, function () {
                        //our turn
    ...
    function toggleCall(user, eventId){
        ...
        getdetails("/play/toggleCallable", values)
            .done(function(response) {
                if (response.success !== undefined) {
        ...
        switch(skillId){
            ...
            case 6:
                ...
                if(arrayData.data.healthPoints < arrayData.data.maxHealth){
                    arrayData.data.healthPoints += arrayData.data.healthPoints * 5 / 100;
        ...
        switch(skillId){
            case 5:
                ...
                if(arrayData.data.owner === user){
                    var overLevel = trainerData[0].data.level - rivalData[0].data.level;
                    if(overLevel > 0){
                        //check if character has the move
                        for(let i=0; i<trainerData[0].moves.length; i++){
                            if(trainerData[0].moves[i].id === 9){
                                //hand of death
                                trainerData[0].moves[i].accuracy += 5*overLevel;
                            }
                        }
                    }
                }
                else if(arrayData.data.owner !== user){
                    var overLevel = rivalData[0].data.level - trainerData[0].data.level;
                    if(overLevel > 0){
                        //check if character has the move
    ...
    function reloadBattleData(){
        ...
        var trainerImg = "/sprites/characters/"+ trainerData[0].data.char_name + "/sprite.png";
        var rivalImg  = "/sprites/characters/"+ rivalData[0].data.char_name + "/sprite.png";
        ...
        $("#trainerBar").append("<div id='tName'>"+tName+"</div>" +
            "<div id='tLevel'>Lv."+tLevel+"</div>" +
            "<div id='tHpBar'>HP: "+tHpBar+"</div>" +
            "<div id='tStBar'>ST: "+tStBar+"</div>");
        ...
        $("#rivalBar").append("<div id='rName'>"+rName+"</div>" +
        ...
        trainerData[0].data.speed = (trainerData[0].data.speedMax / 100 * trainerData[0].data.level);

        rivalData[0].data.atk = (rivalData[0].data.atkMax / 100 * rivalData[0].data.level);
        rivalData[0].data.def = (rivalData[0].data.defMax / 100 * rivalData[0].data.level);
        rivalData[0].data.speed = (rivalData[0].data.speedMax / 100 * rivalData[0].data.level);
    }
