...
(function (a) {
    ...
    function u(a) {
        ...
        a._a &&
            -2 === a._pf.overflow &&
            ((b =
                a._a[gb] < 0 || a._a[gb] > 11
                    ? gb
                    : a._a[hb] < 1 || a._a[hb] > r(a._a[fb], a._a[gb])
                    ? hb
                    : a._a[ib] < 0 || a._a[ib] > 23
                    ? ib
                    : a._a[jb] < 0 || a._a[jb] > 59
                    ? jb
                    : a._a[kb] < 0 || a._a[kb] > 59
                    ? kb
                    : a._a[lb] < 0 || a._a[lb] > 999
                    ? lb
                    : -1),
    ...
    function D(a, b) {
        return a.isValid()
            ? ((b = E(b, a.lang())), Lb[b] || (Lb[b] = C(b)), Lb[b](a))
            : a.lang().invalidDate();
    }
    function E(a, b) {
        function c(a) {
    ...
    function X(a, b, c, d, e) {
        var f,
            g,
            h = new Date(Date.UTC(a, 0)).getUTCDay();
        return (
            (c = null != c ? c : e),
            (f = e - h + (h > d ? 7 : 0)),
            (g = 7 * (b - 1) + (c - e) + f + 1),
    ...
    function Z(a, b) {
        bb.fn[a] = bb.fn[a + "s"] = function (a) {
            ...
            return null != a
                ? (this._d["set" + c + b](a), bb.updateOffset(this), this)
                : this._d["get" + c + b]();
        };
    }
    function $(a) {
    ...
    for (
        var bb,
            ...
            Eb = ["YYYY-MM-DD", "GGGG-[W]WW", "GGGG-[W]WW-E", "YYYY-DDD"],
            Fb = [
            ...
            Gb = /([\+\-]|\d\d)/gi,
            Hb = "Date|Hours|Minutes|Seconds|Milliseconds".split("|"),
            Ib = {
                Milliseconds: 1,
                Seconds: 1e3,
                Minutes: 6e4,
            ...
            Lb = {},
            Mb = "DDD w W M D d".split(" "),
            Nb = "M D H h m s w W".split(" "),
            Ob = {
                M: function () {
                    return this.month() + 1;
                },
    ...
    for (
        Ob.DDDD = b(Ob.DDD, 3),
            ...
            bb = function (b, c, d, e) {
                return (
                    ...
                    Y({ _i: b, _f: c, _l: d, _strict: e, _isUTC: !1 })
                );
            },
            ...
            bb.langData = function (a) {
                return (
                    a && a._lang && a._lang._abbr && (a = a._lang._abbr), A(a)
                );
            },
        ...
        p(Pb[cb]);
    for (
        bb.normalizeUnits = function (a) {
            return n(a);
        },
            bb.invalid = function (a) {
                var b = bb.utc(0 / 0);
                return (
                    null != a ? g(b._pf, a) : (b._pf.userInvalidated = !0), b
                );
            },
            ...
            g((bb.fn = e.prototype), {
                    ...
                    return (
                        ...
                        "year" === b || "month" === b
                            ? ((d =
                              ...
                              (e +=
                                  (this -
                                      bb(this).startOf("month") -
                                      (f - bb(f).startOf("month"))) /
                                  d),
                              (e -=
                                  (6e4 *
                                      (this.zone() -
                                          bb(this).startOf("month").zone() -
                                          (f.zone() -
                                              bb(f).startOf("month").zone()))) /
                                  d),
                              "year" === b && (e /= 12))
                            : ((d = this - f),
                              (e =
                ...
                day: function (a) {
                    var b = this._isUTC
                        ...
                        : this._d.getDay();
                    return null != a
                        ? ((a = T(a, this.lang())), this.add({ d: a - b }))
                        : b;
                },
                month: function (a) {
                    var b,
                ...
                hasAlignedHourOffset: function (a) {
                    return (
                        (a = a ? bb(a).zone() : 0), 0 === (this.zone() - a) % 60
                    );
                },
